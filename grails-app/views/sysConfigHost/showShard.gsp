...
<html>
  <head>
    ...
    <g:set var="entityNameH" value="${message(code: 'sysConfigHost.ConfigHost.label', default: 'ConfigHost')}" />
    <g:set var="entityNameS" value="${message(code: 'sysConfigHost.ShardHost.label', default: 'ShardHost')}" />
      ...
      <ol class="property-list sysConfigHost">
        ...
        <g:if test="${shardHostInstance?.shard || shardHostInstance?.shard == 0}">
          <li class="fieldcontain">
            <span id="shard-label" class="property-label"><g:message code="sysConfigHost.shard.label" default="Shard" /></span>
        ...
        <g:if test="${shardHostInstance?.host}">
          <li class="fieldcontain">
            <span id="host-label" class="property-label"><g:message code="sysConfigHost.url.label" default="Host" /></span>
        ...
        <g:if test="${shardHostInstance?.port}">
          <li class="fieldcontain">
            <span id="port-label" class="property-label"><g:message code="sysConfigHost.port.label" default="Port" /></span>
        ...
        <g:if test="${shardHostInstance?.options}">
          <li class="fieldcontain">
            <span id="options-label" class="property-label"><g:message code="sysConfigHost.options.label" default="Options" /></span>
