...
<html>
  <head>
    ...
    <g:set var="entityNameH" value="${message(code: 'sysConfigHost.label', default: 'ConfigHost')}" />
    <g:set var="entityNameS" value="${message(code: 'sysConfigHost.label', default: 'ShardHost')}" />
