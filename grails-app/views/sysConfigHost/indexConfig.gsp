  ...
  <body>
    ...
    <div class="nav" role="navigation">
      <ul>
        ...
        <!--li><g:link class="list" controller="sysConfigRDS" action="indexConfig"><g:message code="default.list.label" args="[entityNameC]" /></g:link></li-->
        <li><g:link class="create" action="createConfig"><g:message code="default.new.label" args="[entityNameH]" /></g:link></li>
        </ul>
      </div>
      <div id="list-sysConfigHost" class="content scaffold-list" role="main">
      ...
      <table>
        <thead>
          <tr>
            <g:sortableColumn property="name" title="${message(code: 'sysConfigHost.name.label', default: 'Class<br/>Name')}" />
            <g:sortableColumn property="version" title="${message(code: 'sysConfigHost.version.label', default: 'Version')}" />
              <g:sortableColumn property="versionStatus" title="${message(code: 'sysConfigHost.versionStatus.label', default: 'Version<br/>Status')}" />
              <g:sortableColumn property="versionNote" title="${message(code: 'sysConfigHost.versionNote.label', default: 'Version<br/>Note')}" />
                <g:sortableColumn property="shardCount" title="${message(code: 'sysConfigHost.shardCount.label', default: 'Shard<br/>Count')}" />
                  <g:sortableColumn property="shardMap" title="${message(code: 'sysConfigHost.shardMap.label', default: 'Shards')}" />
                  </tr>
                </thead>
                <tbody>
