...
<html>
  <head>
    ...
    <g:set var="entityNameC" value="${message(code: 'sysConfigRDS.label', default: 'ConfigRDS')}" />
    <g:set var="entityNameS" value="${message(code: 'sysConfigRDS.label', default: 'ShardRDS')}" />
