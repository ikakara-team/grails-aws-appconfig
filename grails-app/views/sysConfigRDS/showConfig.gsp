    ...
    <div class="nav" role="navigation">
      ...
      <ol class="property-list sysConfigRDS">
        ...
        <g:if test="${configRDSInstance?.versionStatus}">
          <li class="fieldcontain">
            <span id="versionStatus-label" class="property-label"><g:message code="sysConfigRDS.versionStatus.label" default="Version Status" /></span>
        ...
        <g:if test="${configRDSInstance?.versionNote}">
          <li class="fieldcontain">
            <span id="versionNote-label" class="property-label"><g:message code="sysConfigRDS.versionNote.label" default="Version Note" /></span>
        ...
        <g:if test="${configRDSInstance?.shardCount}">
          <li class="fieldcontain">
            <span id="shardCount-label" class="property-label"><g:message code="sysConfigRDS.shardCount.label" default="Shard Count" /></span>
...
<%--
        <g:if test="${configRDSInstance?.shardMapStr}">
          <li class="fieldcontain">
            <span id="shardMapStr-label" class="property-label"><g:message code="sysConfigRDS.shardMapStr.label" default="Shard Map" /></span>
...
--%>
        <g:if test="${configRDSInstance?.shardMap}">
          <li class="fieldcontain">
            <span id="shardMap-label" class="property-label"><g:message code="sysConfigRDS.shardMap.label" default="Shards" /></span>
