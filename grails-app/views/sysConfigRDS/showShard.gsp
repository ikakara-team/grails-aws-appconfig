...
<html>
  <head>
    ...
    <g:set var="entityNameC" value="${message(code: 'sysConfigRDS.ConfigRDS.label', default: 'ConfigRDS')}" />
    <g:set var="entityNameS" value="${message(code: 'sysConfigRDS.ShardRDS.label', default: 'ShardRDS')}" />
    <title><g:message code="default.show.label" args="[entityNameS]" /></title>
  </head>
  <body>
    <a href="#show-sysConfigRDS" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
    <div class="nav" role="navigation">
      ...
      <div id="show-sysConfigRDS" class="content scaffold-show" role="main">
        <h1><g:message code="default.show.label" args="[entityNameS]" /></h1>
      <g:if test="${flash.message}">
        <div class="message" role="status">${flash.message}</div>
      </g:if>
      <ol class="property-list sysConfigRDS">
        <g:if test="${shardRDSInstance?.id_name}">
          <li class="fieldcontain" style="background-color: #FFAAAA;">
            <span id="name-label" class="property-label"><g:message code="sysConfigRDS.name.label" default="Name" /></span>
        ...
        <g:if test="${shardRDSInstance?.id_version}">
          <li class="fieldcontain" style="background-color: #FFAAAA;">
            <span id="version-label" class="property-label"><g:message code="sysConfigRDS.version.label" default="Version" /></span>
        ...
        <g:if test="${shardRDSInstance?.shard || shardRDSInstance?.shard == 0}">
          <li class="fieldcontain">
            <span id="shard-label" class="property-label"><g:message code="sysConfigRDS.shard.label" default="Shard" /></span>
        ...
        <g:if test="${shardRDSInstance?.driverClassName}">
          <li class="fieldcontain">
            <span id="driverClassName-label" class="property-label"><g:message code="sysConfigRDS.driverClassName.label" default="Driver Name" /></span>
        ...
        <g:if test="${shardRDSInstance?.url}">
          <li class="fieldcontain">
            <span id="url-label" class="property-label"><g:message code="sysConfigRDS.url.label" default="Url" /></span>
        ...
        <g:if test="${shardRDSInstance?.db}">
          <li class="fieldcontain">
            <span id="db-label" class="property-label"><g:message code="sysConfigRDS.db.label" default="Db" /></span>
        ...
        <g:if test="${shardRDSInstance?.username}">
          <li class="fieldcontain">
            <span id="username-label" class="property-label"><g:message code="sysConfigRDS.username.label" default="Username" /></span>
        ...
        <g:if test="${shardRDSInstance?.password}">
          <li class="fieldcontain">
            <span id="password-label" class="property-label"><g:message code="sysConfigRDS.password.label" default="Password" /></span>
        ...
        <g:if test="${shardRDSInstance?.options}">
          <li class="fieldcontain">
            <span id="options-label" class="property-label"><g:message code="sysConfigRDS.options.label" default="Options" /></span>
